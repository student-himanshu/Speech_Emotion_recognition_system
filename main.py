...
# Create two tabs
tab1, tab2 = st.tabs(["🎭 Emotion Recognition", "🗣 Speech Recognition"])
...
with tab1:
    ...
    start_emotion = st.button("▶ Start Emotion Recognition")
    stop_emotion = st.button("⏹ Stop Emotion Recognition")
...
with tab2:
    ...
    start_speech = st.button("🎙 Start Speech Recognition")
...
# Footer
st.markdown("---")
st.markdown("<h4 style='text-align: center;'>Made by Himanshu Mishra</h4>", unsafe_allow_html=True)